...
class ArbreBRCons extends ArbreBR {
    ...
    public void rechercherSolutions(String lettresJoueur, ArrayList<Mot> possibilites) {
        if (getRacine().motOK(lettresJoueur)) {
            possibilites.add(getRacine());
        }
        System.out.println(getRacine().getMot());
        getAg().rechercherSolutions(lettresJoueur, possibilites);
        getAd().rechercherSolutions(lettresJoueur, possibilites);
    }
